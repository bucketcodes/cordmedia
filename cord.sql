...
--
-- Indexes for table `field_hero_image`
--
ALTER TABLE `field_hero_image`
  ADD PRIMARY KEY (`pages_id`,`sort`),
  ADD KEY `data` (`data`),
  ADD KEY `modified` (`modified`),
  ADD KEY `created` (`created`);
ALTER TABLE `field_hero_image` ADD FULLTEXT KEY `description` (`description`);
ALTER TABLE `field_hero_image` ADD FULLTEXT KEY `filedata` (`filedata`);

--
-- Indexes for table `field_hero_slogan`
--
ALTER TABLE `field_hero_slogan`
  ADD PRIMARY KEY (`pages_id`),
  ADD KEY `data_exact` (`data`(250));
ALTER TABLE `field_hero_slogan` ADD FULLTEXT KEY `data` (`data`);
...
ALTER TABLE `field_position`
  ADD PRIMARY KEY (`pages_id`),
  ADD KEY `data_exact` (`data`(250));
ALTER TABLE `field_position` ADD FULLTEXT KEY `data` (`data`);
...
--
-- Indexes for table `field_slideshow_image`
--
ALTER TABLE `field_slideshow_image`
  ADD PRIMARY KEY (`pages_id`,`sort`),
  ADD KEY `data` (`data`),
  ADD KEY `modified` (`modified`),
  ADD KEY `created` (`created`);
ALTER TABLE `field_slideshow_image` ADD FULLTEXT KEY `description` (`description`);
ALTER TABLE `field_slideshow_image` ADD FULLTEXT KEY `filedata` (`filedata`);
